# Recorded Example Run: Enquire Pet Policy

- Pipeline ID: `refiniment-enquire_pet_policy-V2`
- Status: `completed`
- Target score: `8`
- Scenario: Answer a customer question about whether pets are allowed and under what conditions.
- Starting user prompt: Are pets allowed on board, and what are the conditions for bringing one?

## Scores Per Iteration

| Iteration | Scenario | Overall | Lowest Criterion | Root Cause | Changed |
| --- | --- | --- | --- | --- | --- |
| 1 | Enquire Pet Policy | 3/10 | 4/10 | prompt | 1 |
| 2 | Enquire Pet Policy | 9/10 | 9/10 | — | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 1 | Enquire Pet Policy | 7/10 | 9/10 | 4/10 | 7/10 |
| 2 | Enquire Pet Policy | 10/10 | 10/10 | 9/10 | 9/10 |

## Performance Improvement

Enquire Pet Policy moved from 3/10 to 9/10.
