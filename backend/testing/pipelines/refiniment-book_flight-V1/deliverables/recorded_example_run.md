# Recorded Example Run: Book Flight

- Pipeline ID: `refiniment-book_flight-V1`
- Status: `completed`
- Target score: `8`
- Scenario: Book a flight for one adult after finding a suitable option.
- Starting user prompt: Book the next available business-class flight from ATH to JFK for one adult.

## Scores Per Iteration

| Iteration | Scenario | Overall | Lowest Criterion | Root Cause | Changed |
| --- | --- | --- | --- | --- | --- |
| 1 | Book Flight | 9/10 | 8/10 | — | 0 |
...
| --- | --- | --- | --- | --- | --- |
| 1 | Book Flight | 9/10 | 10/10 | 10/10 | 8/10 |

## Performance Improvement

Book Flight moved from 9/10 to 9/10.
